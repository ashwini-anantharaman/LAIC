/** Tutorial V3 template store — isolated from V1 (`laic-tutorial-templates`). */
...
export const FREEFORM_TUTORIAL_TEMPLATE_ID = 'v3-author-freeform';
 ...
 */
export const WRITE_YOURSELF_TUTORIAL_TEMPLATE_ID = 'v3-write-yourself';
 ...
 */
export const BLANK_CANVAS_TUTORIAL_TEMPLATE_ID = 'v3-blank-canvas';
...
export const BUILTIN_TUTORIAL_TEMPLATES: TutorialTemplate[] = [
  packTemplate({
    id: 'v3-concept-example-practice',
  ...
  packTemplate({
    id: 'v3-explain-misconception-correct',
...
export const DEFAULT_TUTORIAL_TEMPLATE_ID = 'v3-concept-example-practice';

const STORAGE_KEY = 'laic-tutorial-v3-templates';
