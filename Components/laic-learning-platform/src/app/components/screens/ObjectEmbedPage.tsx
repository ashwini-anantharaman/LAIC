  ...
  if (!obj) {
    return (
      ...
      >
        ...
        <p style={{ fontSize: 16, fontWeight: 700, color: '#0B1220' }}>Object not found</p>
        <p style={{ fontSize: 13, color: '#6B7280', marginTop: 6, maxWidth: 360 }}>
          No activity object with id <code style={{ fontSize: 12 }}>{objectId}</code> is available in this browser.
        </p>
      </div>
    );
  }
