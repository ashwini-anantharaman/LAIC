/**
 * Tutorial V3 Sources panel — UI clone of V1 ObjectCreator TutorialSource.
 * Forked into tutorialV3/ so the original Tutorial path stays untouched.
 */
...
export function TutorialV3SourcePanel(props: any) {
  const {
