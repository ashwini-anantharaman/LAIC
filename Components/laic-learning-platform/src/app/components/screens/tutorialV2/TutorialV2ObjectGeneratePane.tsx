/**
 * Full per-type generate pipeline inside a Tutorial V2 generate slot.
...
import {
  defaultDefineConfig,
  objectTypeNoun,
} from '../../../../lib/tutorialV2/objectPipelineDefaults';
import type { TutorialV2Part, V2SourceRef, V2TopLevelSlot } from '../../../../lib/tutorialV2/types';
...
export function TutorialV2ObjectGeneratePane({
  slot,
  pool,
  tutorialTitle,
  tutorialObjective,
  ...
  onGenerated: (part: TutorialV2Part) => void;
}) {
