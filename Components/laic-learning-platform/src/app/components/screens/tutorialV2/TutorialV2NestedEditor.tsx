/**
 * Opens the dedicated per-type editor for a Tutorial V2 embed / learning-object part.
...
import type { TutorialV2Part } from '../../../../lib/tutorialV2/types';
import {
...
export function TutorialV2NestedEditor({
  part,
  scope = 'bridge',
  onBack,
  onApply,
  ...
  scope?: string;
  onBack: () => void;
  onApply: (patch: Partial<TutorialV2Part>) => void;
