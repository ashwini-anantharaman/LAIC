/**
 * Tutorial V2 Plan panel — clone of V1 TutorialPlanPanel (template-driven outline + embeds).
 */
...
import {
  ...
  type ListedEmbed,
} from '../../../../lib/tutorialV2/tutorialDefinition';
import {
...
export function TutorialV2PlanPanel({
  def,
  setDef,
  template,
  templateName,
