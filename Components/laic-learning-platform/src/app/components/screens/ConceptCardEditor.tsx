...
export function ConceptCardEditor({
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-3 sm:px-5 py-4 sm:py-6 max-w-3xl mx-auto w-full">
        {mode === 'preview' ? (
          <>
          ...
          <>
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:justify-between mb-3">
              ...
              <button onClick={() => setAiOpen((v) => !v)} className="flex items-center justify-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold shrink-0 self-start sm:self-auto"
