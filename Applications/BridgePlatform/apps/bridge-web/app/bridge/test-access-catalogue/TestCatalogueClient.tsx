...
// 1), and the flat 34-key feature matrix the app enforces recomputes on the
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-lg border border-neutral-200 p-4">
        ...
        <p className="mb-3 text-sm text-neutral-600">
          The read-only 34-key feature matrix the app actually enforces, computed live from the set
