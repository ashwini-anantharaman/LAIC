 ...
 *  37-key matrix, optionally write it to the live catalogue. Gated behind the
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-neutral-600">
          ...
          37-key feature matrix the app enforces, and — if you can edit — write that compiled
