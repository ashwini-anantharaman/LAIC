...
(currently: Phases 0–4 complete — shell, contracts, engine + interpreter,
knowledge base with published Beginner Natural v0, persistent sessions). Before touching bridge code, read that plan's
